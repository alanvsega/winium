  ...
  return (
    <div className="background-container background-main-light">
      <div className="user-login-container background-main-gradient">
        ...
        <form action="" className="login-form font-color-light">
          ...
          <div className="button-options-container">
            <Link
              to="/create-account"
              className="featured-button signup-button"
            >
              <p className="font-color-highlight-light">Sign Up</p>
            </Link>
            <button
              type="submit"
              className="featured-button background-highlight"
            >
      ...
      <div className="aside-image-container">
        <img src={WineTasterImage} alt="Wine taster" />
      </div>
    </div>
  );
}
